...
Assuming you are using TBEL in the Rule Engine to define a simple script [filter node](https://docs.sensef.ru/docs/user-guide/rule-engine-2-0/filter-nodes/#script-filter-node):
