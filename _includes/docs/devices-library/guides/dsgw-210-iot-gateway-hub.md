...
You can use [ThingsBoard Cloud](https://thingsboard.cloud/signup){:target="_blank"} or [install](https://docs.sensef.ru/docs/user-guide/install/pe/installation-options/){:target="_blank"} your own platform instance.
