...
{% if docsPrefix == "pe/" %}
- The instance of the [ThingsBoard Professional Edition](https://docs.sensef.ru/docs/user-guide/install/pe/installation-options/){:target="_blank"} installed locally;
