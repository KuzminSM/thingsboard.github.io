    ...
    <div class="mobile-frame ios">
        ...
        <div class="frame-video">
            <video autoplay loop preload="auto" muted playsinline>
                 <source src="https://docs.sensef.ru/images/mobile/{{docsPrefix}}alarm-dashboard.mp4" type="video/mp4">
                 <source src="https://docs.sensef.ru/images/mobile/{{docsPrefix}}alarm-dashboard.webm" type="video/webm">
            </video>
        </div>
    </div>
</div>
