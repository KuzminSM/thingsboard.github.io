...
Read more about the APPLICATION client [here](https://docs.sensef.ru/docs/mqtt-broker/user-guide/mqtt-client-type/).
...
In this tutorial, we will use:
 ...
 - [TBMQ](https://docs.sensef.ru/docs/mqtt-broker/install/installation-options/) installed **locally** and accessible by ThingsBoard PE instance;
