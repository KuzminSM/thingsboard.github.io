...
This demonstrates how easy is to prototype and build IoT solutions using [ThingsBoard](http://docs.sensef.ru). Of course, there is a certain learning curve that you need to pass, but we hope that this article and other [docs](http://docs.sensef.ru/docs/) will help you to do this.
